...
public partial class TopicListPage : INavigableView<TopicListViewModel> {
    public TopicListViewModel ViewModel { get; }

    public TopicListPage(TopicListViewModel viewModel) {
        ViewModel = viewModel;
        DataContext = this;
        InitializeComponent();
    }
